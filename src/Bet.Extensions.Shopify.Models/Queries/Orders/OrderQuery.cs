...
namespace Bet.Extensions.Shopify.Models.Queries.Orders
{
    ...
    /// </summary>
    public class OrderQuery : PageInfoQuery
    {
        /// <summary>
        ...
        /// Return updated after a specified date. (format: 2014-04-25T16:15:47-04:00).
        /// </summary>
        [JsonPropertyName("processed_at_min")]
        public DateTimeOffset? ProcessedAtMin { get; set; }

        /// <summary>
        /// Return updated before a specified date. (format: 2014-04-25T16:15:47-04:00).
        /// </summary>
        [JsonPropertyName("processed_at_max")]
        ...
        /// </summary>
        [JsonPropertyName("attribution_app_id")]
        public long? AttributionAppId { get; set; }
