...
public static class ShopifyAspNetCoreServiceCollection
{
    ...
    /// <param name="configure">The configuration for <see cref="HmacValidationOptions"/>.</param>
    /// <returns></returns>
        ...
        Action<HmacValidationOptions, IServiceProvider>? configure = default)
    {
        services.AddChangeTokenOptions<HmacValidationOptions>(
            ...
            configureAction: (o, sp) => configure?.Invoke(o, sp));
    ...
    /// <summary>
    /// Adds Shopify Webhooks middleware configurations.
    /// </summary>
    /// <param name="services">The DI services.</param>
